					...
					<div class="coupon">
						...
						<div>
							...
							<?php if ( WC()->cart->get_coupons()) : ?>
								<br><p><?php echo __('Atlaide ir piemērota no pilnas produkta cenas. Akcijas nesummējas un bezmaksas produkts šim pasūtījumam netiks pievienots!','woocommerce');?></p>
							<?php endif;?>
						</div>
